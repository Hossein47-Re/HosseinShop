...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      $message[] = 'پسورد قبلی خود را وارد کنید';
   }elseif($old_pass != $prev_pass){
      $message[] = 'با پسورد قبلی تطابق ندارد';
   }elseif($new_pass != $confirm_pass){
      $message[] = 'با پسورد تطابق ندارد';
   }else{
      if($new_pass != $empty_pass){
         ...
         $message[] = 'لطقا پسورد جدید را وارد کنید';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="submit" value="بروز رسانی" class="btn" name="submit">
   </form>
